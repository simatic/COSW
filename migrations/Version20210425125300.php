 ...
 */
final class Version20210425125300 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__item AS SELECT id, title, rubrique_id FROM item');
        ...
        $this->addSql('INSERT INTO item (id, title, rubrique_id) SELECT id, title, rubrique_id FROM __temp__item');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE item');
        $this->addSql('CREATE TABLE item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, rubrique_id INTEGER DEFAULT NULL)');
